...
<div id="root">
    ...
    <div class="collapse navbar-collapse" id="nvbarCollapse">
      ...
      data-toggle="collapse" data-target="#nvbarCollapse">  <i class="fas fa-user" >
    </button></i>
        </button>
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                                <a href="home.php" class="nav-item-navbar nav-item-highlighted" >Home</a>&nbsp;&nbsp;&nbsp;
                                <a href="deals.php" class="nav-item-navbar">Catalogues &amp; Deals</a>&nbsp;&nbsp;&nbsp;
                                <a href="storelocator.php" class="nav-item-navbar"> Stores</a>&nbsp;&nbsp;&nbsp;
                                <a href="contactus.php" class="nav-item-navbar">  Contact us      </a>&nbsp;&nbsp;&nbsp;
