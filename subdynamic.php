...
$catid=$_GET['catid'];
//echo $catid;
        $query = "SELECT products.*,p2s.quantity_in_stock, p2s.sell_price as sell_price, p2s.purchase_price as purchase_price FROM products LEFT JOIN product_to_store p2s ON (products.p_id = p2s.product_id) GROUP BY products.p_id HAVING  category_id = '$catid' AND sub_id= '$subid' ";
...
<div class="main-content-holder">
    ...
    <?php
    //echo $idc;
    $query = "SELECT products.*,p2s.quantity_in_stock, p2s.sell_price as sell_price, p2s.purchase_price as purchase_price FROM products LEFT JOIN product_to_store p2s ON (products.p_id = p2s.product_id) GROUP BY products.p_id HAVING quantity_in_stock != '' AND  category_id = '$catid' AND sub_id= '$subid'";
