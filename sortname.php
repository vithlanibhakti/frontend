...
class ShoppingCartd extends DBController
{
    ...
    function getAllProduct()
    {
        ...
        $query = "SELECT products.*,p2s.quantity_in_stock, p2s.sell_price as sell_price, p2s.purchase_price as purchase_price FROM products LEFT JOIN product_to_store p2s ON (products.p_id = p2s.product_id) GROUP BY products.p_id HAVING  category_id = '$idc' AND quantity_in_stock != '' ORDER BY p_name";
